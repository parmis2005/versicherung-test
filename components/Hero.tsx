...
export default function Hero() {
  return (
    <section className="relative min-h-screen overflow-hidden bg-[#0f2044] flex flex-col sm:block">
      ...
      {/* Main Content */}
      <div className="relative z-10 flex-1 sm:flex-none w-full max-w-6xl mx-auto px-6 sm:px-8 lg:px-10 pt-0 pb-20 sm:min-h-screen sm:pt-32 sm:pb-16 flex flex-col items-center justify-center text-center">
        {/* Kicker */}
